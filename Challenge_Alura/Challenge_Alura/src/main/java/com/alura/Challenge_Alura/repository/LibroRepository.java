 ...
 */
@Repository
public interface LibroRepository extends JpaRepository<Nombre_libro, Long> {
     ...
     */
    Optional<Nombre_libro> findByTituloIgnoreCase(String titulo);
     ...
     */
    @Query("SELECT l FROM Nombre_libro l WHERE l.idioma = :idioma")
    List<Nombre_libro> findByIdioma(@Param("idioma") String idioma);
}
